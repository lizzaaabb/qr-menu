...
const dishes = [
  { id: 1, label: 'მოჰიტო',          sublabel: 'Caesar Salad', img: '/drink1.png', desc: 'რომენის სალათა, კრუტონები, პარმეზანი', price: '18' },
  { id: 2, label: 'კოქტეილი', sublabel: 'Greek Salad',  img: '/drink2.png', desc: 'პომიდორი, კიტრი, ფეტა, ზეითუნი',      price: '16' },
  { id: 3, label: 'მარტინი',            sublabel: 'Taco',          img: '/drink3.png', desc: 'ახალი ბოსტნეული, სალსა, ავოკადო',     price: '14' },
  { id: 4, label: 'მარგარიტა',         sublabel: 'Caprese',       img: '/drink4.png', desc: 'მოცარელა, პომიდორი, ბაზილიკი',        price: '15' },
]
    ...
    <div className="cold-wrap">
      ...
      <div className="cold-hd">
        ...
        <div className="cold-hd-center">
          <div className="cold-eyebrow">Cocktails</div>
          <div className="cold-title">სასმელები</div>
        </div>
