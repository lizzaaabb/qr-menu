...
const dishes = [
  { id: 1, label: 'ხაჭაპური',          sublabel: 'Caesar Salad', img: '/comi1.png', desc: 'რომენის სალათა, კრუტონები, პარმეზანი', price: '18' },
  { id: 2, label: 'პიცა', sublabel: 'Greek Salad',  img: '/comi2.png', desc: 'პომიდორი, კიტრი, ფეტა, ზეითუნი',      price: '16' },
  { id: 3, label: 'ხინკალი',            sublabel: 'Taco',          img: '/comi3.png', desc: 'ახალი ბოსტნეული, სალსა, ავოკადო',     price: '14' },
  { id: 4, label: 'პიცა',         sublabel: 'Caprese',       img: '/comi4.png', desc: 'მოცარელა, პომიდორი, ბაზილიკი',        price: '15' },
]
    ...
    <div className="cold-wrap">
      ...
      <div className="cold-hd">
        ...
        <div className="cold-hd-center">
          <div className="cold-eyebrow">Pastry</div>
          <div className="cold-title">ცომეული</div>
        </div>
